...
const WfoCover: React.FC<{
  ...
  return (
    <div
      className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg transition-bg h-full w-full flex dark-hover bg-slate-800"
      style={{
        aspectRatio: "1/1",
    ...
    >
      <p
        className={`font-caveat text-5xl m-auto p-1 w-full transition-bg ${
          props.mode === "colorful" ? "text-slate-800" : "text-slate-200"
        }`}
      >
        {getWfoTeamString()}
      </p>
